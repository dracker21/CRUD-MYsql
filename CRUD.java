...
public class CRUD extends javax.swing.JFrame {
    ...
    public CRUD() {
        ...
        this.setLocationRelativeTo(null); //este codigo colocara el formulario centrado
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Derechos Reservados Creado por: Jorge Sanchez 2020.");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        try {
            ...
            preparedStatement = connection.prepareStatement("INSERT INTO persona (clave, nombre, telefono) VALUES (?,?,?)");
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        try {
            connection = Conexion.getConnection();
            preparedStatement = connection.prepareStatement("SELECT id, nombre, telefono FROM persona WHERE clave=?");
            preparedStatement.setString(1, txtClave.getText());
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        try {
            connection = Conexion.getConnection();
            preparedStatement = connection.prepareStatement("UPDATE persona SET clave=?, nombre=?, telefono=? WHERE id=?");
            preparedStatement.setString(1, txtClave.getText());
            preparedStatement.setString(2, txtNombre.getText());
            preparedStatement.setString(3, txtTelefono.getText());
         /*   preparedStatement.setDate(4, Date.valueOf(txtFechaNacimiento.getText()));*/
